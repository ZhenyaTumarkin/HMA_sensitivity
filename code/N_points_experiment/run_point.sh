...
rm ${outloc}/run_list.csv
echo  ",glacier_id,point_id"> ${outloc}/run_list.csv
echo  ",RGI60-13.19847,$point_id">> ${outloc}/run_list.csv

sbatch --parsable  --array=1  --export=outlocation=$outloc ${root}/bash_scripts/array_run_model.sh